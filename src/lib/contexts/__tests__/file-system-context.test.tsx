...
// Tool call tests
test("handles edit_file create command", () => {
...
test("handles edit_file create command with error", () => {
...
test("handles edit_file str_replace command", () => {
...
test("handles edit_file str_replace command with error", () => {
...
test("handles edit_file insert command", () => {
...
test("handles edit_file insert command with error", () => {
